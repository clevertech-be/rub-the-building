...
export default function ContactCard({ className }) {
  ...
  return (
    <div
      className={
        className ||
        'flex justify-between items-start md:items-center md:flex-row flex-col gap-2 bg-contrast-800 rounded-xl text-white font-bold p-6 w-full'
      }
    >
      <div className='text-xl xl:text-2xl'>{t('contact.card.title')}</div>
